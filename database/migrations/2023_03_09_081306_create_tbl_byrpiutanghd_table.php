...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tbl_byrpiutanghd', function (Blueprint $table) {
            $table->string('notransaksi', 50)->primary();
            $table->string('kodekantor', 50)->nullable()->index('kodekantor2');
            $table->timestamp('tanggal')->nullable();
            $table->string('tipe', 20)->nullable();
            $table->string('kodesupel', 50)->nullable()->index('kodesupplier1');
            $table->string('matauang', 50)->nullable()->index('matauang5');
    ...
    {
        Schema::dropIfExists('tbl_byrpiutanghd');
    }
};

...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tbl_byrpiutangdt', function (Blueprint $table) {
            $table->string('iddetail', 150)->primary();
            $table->string('notransaksi', 50)->nullable()->index('notransaksi2');
            $table->string('notrsmasuk', 50)->nullable()->index('notrsmasuk1');
            $table->string('tipe', 20)->nullable();
            $table->string('matauang', 50)->nullable()->index('matauang4');
    ...
    {
        Schema::dropIfExists('tbl_byrpiutangdt');
    }
};
